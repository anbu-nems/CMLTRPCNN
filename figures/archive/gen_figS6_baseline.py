...
fig.text(0.50, -0.02,
         "Physics constraints reduce OOD variance 4× vs PIRNN (CV std: 0.043 vs 0.181) "
         "while matching holdout accuracy",
         ha="center", fontsize=6.5, color="#444", style="italic")
...
fig.legend(handles=legend_items, loc="upper right",
           bbox_to_anchor=(1.0, 1.02), ncol=3, fontsize=6.5,
