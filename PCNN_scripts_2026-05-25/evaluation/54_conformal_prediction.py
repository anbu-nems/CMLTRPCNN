...
def main():
    ...
    fig.suptitle("CMLTRPCNNv77 — Split conformal prediction (calibration n=123)",
    ...
    print(f"  Manuscript statement  : 'Conformally-calibrated 90% prediction")
    print(f"  intervals of ±{q90_abs:.0f} (absolute) cover {coverage(y_true, y_pred, q90_abs)*100:.0f}%")
    print(f"  of held-out compositions (n=123), providing statistically")
    print(f"  guaranteed uncertainty bounds without model retraining.'")
