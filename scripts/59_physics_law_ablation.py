...
COMP_DIR = os.path.join(RELEASE_ROOT, "comparison")
...
ckpt = torch.load(os.path.join(ROOT, "model_weights", "cmltrv77_final.pt"),
                  map_location="cpu", weights_only=False)
hp   = ckpt["hp"]

with open(os.path.join(ROOT, "model_weights", "cmltrv77_scalers.pkl"), "rb") as f:
...
ax.set_ylabel("Test R² (held-out, n=116)")
